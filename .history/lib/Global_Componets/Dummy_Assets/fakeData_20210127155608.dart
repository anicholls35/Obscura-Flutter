...
final List<PostMetaData> posts = [
  ...
  PostMetaData(
    uploader: users[0],
    geoLocation: "Edinburgh, UK",
    postImage: Image.network('https://images.unsplash.com/photo-1611222777277-61319d63ca94?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1653&q=80')
    comments: getComments(),
    rating: getRating(),
  ),
  PostMetaData(
