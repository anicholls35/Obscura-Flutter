...
final List<PostMetaData> posts = [
  ...
  PostMetaData(
    ...
    postImage: Image.network('https://images.unsplash.com/photo-1591088398332-8a7791972843?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1867&q=80')
    comments: getComments(),
    rating: getRating(),
  ),
  PostMetaData(
