...
final List<PostMetaData> posts = [
  ...
  PostMetaData(
    ...
    postImage: https://images.unsplash.com/photo-1611171711810-bd87831ade4c?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1234&q=80
    comments: getComments(),
    rating: getRating(),
  ),
  PostMetaData(
