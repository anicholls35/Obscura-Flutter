...
final List<PostMetaData> posts = [
  ...
  PostMetaData(
    ...
    postImage: Image.network('https://images.unsplash.com/photo-1611182085226-9fdc2357c029?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1697&q=80')
    comments: getComments(),
    rating: getRating(),
  ),
  PostMetaData(
