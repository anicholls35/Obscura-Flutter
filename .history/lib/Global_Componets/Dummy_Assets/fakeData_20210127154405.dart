...
final List<UserAccount> users = [
  UserAccount(
    ...
    profilePicture: Image(
      image: AssetImage('assets/Images/ProfilePictures/adamNicholls.jpg'),
    ),
    posts: 10,
    followers: 250,
    following: 300,
  ...
  UserAccount(
    ...
    profilePicture: Image.network('https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg')
  ),
  UserAccount(
    userName: 'Alex',
    profilePicture: Image(
