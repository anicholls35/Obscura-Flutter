...
final List<UserAccount> users = [
  UserAccount(
    ...
    profilePicture:
        Image.asset('assets/Images/ProfilePictures/adamNicholls.jpg'),
    posts: 10,
    followers: 250,
    following: 300,
  ),
...
final List<PostMetaData> posts = [
  ...
  PostMetaData(
    uploader: users[1],
    geoLocation: "New York, USA",
    postImage: Image.network('https://images.unsplash.com/photo-1611209009772-d40fd03d510d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1232&q=80')
    comments: getComments(),
    rating: getRating(),
  ),
];
