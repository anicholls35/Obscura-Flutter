...
final List<PostMetaData> posts = [
  ...
  PostMetaData(
    uploader: users[2],
    geoLocation: "New York, USA",
    postImage: Image.network('https://images.unsplash.com/photo-1550316151-1e372c5dcfb0?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1700&q=80')
    comments: getComments(),
    rating: getRating(),
  ),
  PostMetaData(
