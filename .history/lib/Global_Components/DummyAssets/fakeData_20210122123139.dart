...
final List<PostMetaData> posts = [
  PostMetaData(
      uploader: users[0], geoLocation: 'Edinburgh, UK', postImage: NetworkImage('https://images.unsplash.com/photo-1611224997828-1a7bf247d2e0?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80')),
];
