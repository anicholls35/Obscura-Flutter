...
class LoginColumn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OldCol(formTextStyle: formTextStyle, formPaddingInsets: formPaddingInsets, formEdgeInsetsGeometry: formEdgeInsetsGeometry, buttonTextStyle: buttonTextStyle, buttonEdgeInsetsGeometry: buttonEdgeInsetsGeometry, buttonPaddingInsets: buttonPaddingInsets);
  }
}
