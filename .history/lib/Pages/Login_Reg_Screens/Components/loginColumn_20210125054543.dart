  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        LoginButton(buttonText: 'Login'.toUpperCase(), buttonColor: accentColour, textStyle: buttonTextStyle, edgeInsetsGeometry: edgeInsetsGeometry, paddingInsets: paddingInsets)
      ],
    );
  }
}
