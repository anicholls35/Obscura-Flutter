  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        LoginButton(buttonText: 'Login'.toUpperCase(), buttonColor: accentColour, textStyle: textStyle, edgeInsetsGeometry: edgeInsetsGeometry, paddingInsets: paddingInsets)
      ],
    );
  }
}
