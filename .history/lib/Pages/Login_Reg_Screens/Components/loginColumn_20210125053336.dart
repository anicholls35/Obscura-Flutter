...
class LoginColumn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        LoginFormField(formText: "username", textStyle: textStyle, edgeInsetsGeometry: edgeInsetsGeometry, paddingInsets: paddingInsets, fillColor: fillColor, obscure: obscure)
      ],
    );
  }
}
