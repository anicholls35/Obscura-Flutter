  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        LoginButton(buttonText: 'Login'.toUpperCase(), buttonColor: buttonColor, textStyle: textStyle, edgeInsetsGeometry: edgeInsetsGeometry, paddingInsets: paddingInsets)
      ],
    );
  }
}
