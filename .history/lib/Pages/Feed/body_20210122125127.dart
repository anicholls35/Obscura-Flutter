...
class Body extends StatelessWidget {
  ...
  genFeed() {
    ...
    for (int i = 0; i < posts.length; i++) {
      _feed.add(FeedPost(uploaderName: posts[i].uploader.userName, uploaderProfilePic: posts[i].uploader.profilePicture, rating: getRating(), commentsTotal: getCom, geoLocation: geoLocation, postImage: postImage));
    }
  }
