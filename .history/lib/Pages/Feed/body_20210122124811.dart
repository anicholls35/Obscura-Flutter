...
class Body extends StatelessWidget {
  ...
  genFeed() {
    ...
    for (int i = 0; i < posts.length; i++) {
      _feed.add(FeedPost(uploaderName: posts, uploaderProfilePic: uploaderProfilePic, rating: rating, commentsTotal: commentsTotal, geoLocation: geoLocation, postImage: postImage));
    }
  }
