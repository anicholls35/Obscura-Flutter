...
import 'package:obscura/Pages/ProfilePosts.dart';

import 'ProfileFollowers.dart';
import 'ProfileSplashscreen.dart';
import 'ProfileSplashscreenFollowing.dart';
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(
                        width * 0.425, height * 0.79, width * 0.15, 1.0),
                    size: Size(width, height),
                    //pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
...
const String _svg_9zgg2p =
    '<svg viewBox="328.5 852.5 72.0 1.0" ><path transform="translate(328.5, 852.5)" d="M 0 0 L 72 0" fill="none" stroke="#d0005d" stroke-width="3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
