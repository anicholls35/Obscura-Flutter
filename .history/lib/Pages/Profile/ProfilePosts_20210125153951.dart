...
import 'package:obscura/Pages/ProfileFollowers.dart';
import 'package:obscura/Pages/ProfileFollowing.dart';
import 'package:obscura/Pages/ProfileSplashscreenFollowing.dart';
import 'package:obscura/Pages/ProfileSplashscreen.dart';
        ...
        children: <Widget>[
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(
                        width * 0.05, height * 0.79, width * 0.15, 1.0),
                    size: Size(width, height),
                    //pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
          ...
          Transform.translate(
            ...
            child:
                ...
                SizedBox(
              width: follow_radius,
              height: follow_radius,
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(4, 2, follow_radius, follow_radius),
...
const String _svg_r2ffxb =
    '<svg viewBox="19.5 852.5 72.0 1.0" ><path transform="translate(19.5, 852.5)" d="M 0 0 L 72 0" fill="none" stroke="#d0005d" stroke-width="3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
