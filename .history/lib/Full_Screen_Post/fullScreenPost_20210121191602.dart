...
class FullScreenPost extends StatelessWidget {
  ...
  const FullScreenPost({Key key, @required this.image, @required this.uploaderProfilePic, @required this.uploaderName, @required this.geoLocation, @required this.}) : super(key: key);
